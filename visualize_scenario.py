...
if __name__ == "__main__":
    argoverse_scenario_dir = "/dev_ws/src/tam_deep_prediction/data/raceverse-small-v2/realmotion_processed/train"
    viz_output_dir = "/Users/juliaxixixu/tam_deep_prediction/visualizations/test"
